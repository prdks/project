            ...
            success: function(data) {
                ...
                if (data.pic1 != 0) {
                    ...
                    $('.edit_picture1').click(function() {
                        ...
                        if (btn_txt === 'เปลี่ยนรูปภาพ') { $(this).html('ยกเลิก'); } else { $(this).html('เปลี่ยนรูปภาพ');
                            $('input[name=filUpload0]').val('') }
