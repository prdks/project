       ...
       <?php
         while($row = $result->fetch_assoc())
         {
           ...
           <?php
             ...
             <td class="text-center">
             <button type="submit" class="btn btn-primary btn-block handleRerserveDetail" role="button"
             data-toggle="modal" data-target="#reserv_detail_modal" data-id="<?php echo $row["reservation_id"];?>">
