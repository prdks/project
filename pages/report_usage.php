    ...
    <div id="wrapper">
      ...
      <!-- ./Navigation -->
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header">ออกรายการงานการใช้รถยนต์</h3>
                </div>
            </div>
            <!-- searchbox -->
            <div class="row">
                      ...
                      <form action="<?=$_SERVER['PHP_SELF'];?>" class="form-horizontal" method="POST">
                        <div class="panel-body">
                          ...
                          <div class="text-right" style="margin-top:10px;">
                              <button name="query_report_usage" type="submit" class="btn btn-success"><i class="fa fa-search"></i> แสดงผลลัพธ์</button>
                          </div>
                        </div>
                        </form>
                    </div>
            ...
            <?php include 'querydata/reportusage/table.php';  ?>
