  ...
  function updateUserPass() 
  {
    ...
    $.ajax({
      ...
      success: function(data){
        ...
        {
          swal({
              title: "แก้ไขรหัสผ่านผิดพลาด กรุณาทำรายการใหม่",
              text: "แจ้งเตือนจะปิดเองภายใน 2 วินาที",
              type: "error",
              timer: 2000,
              showConfirmButton: false,
  ...
  function updateData() 
  {
    ...
    $.ajax({
      ...
      success: function(data){
        ...
        {
          swal({
              title: "แก้ไขข้อมูลคณะผิดพลาด กรุณาทำรายการใหม่",
              text: "แจ้งเตือนจะปิดเองภายใน 2 วินาที",
              type: "error",
              timer: 2000,
              showConfirmButton: false,
    ...
    $.ajax({
      ...
      success: function(data){
        if (data.result == 1)
          ...
          {
            swal({
                title: "แก้ไขรูปโลโก้คณะผิดพลาด กรุณาทำรายการใหม่",
                text: "แจ้งเตือนจะปิดเองภายใน 2 วินาที",
                type: "error",
                timer: 2000,
                showConfirmButton: false,
  ...
  function insertdata() {
    ...
    $.ajax({
      ...
      success: function(data){
        ...
        {
          swal({
                title: "การตั้งค่าผิดพลาด กรุณาทำรายการใหม่",
                text: "แจ้งเตือนจะปิดเองภายใน 2 วินาที",
                 type: "error",
                timer: 2000,
                showConfirmButton: false,
