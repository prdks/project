...
if(isset($_POST['handleSearch']))
{
  ...
  if ($result_row !== 0) // ถ้าใน Table มีข้อมูล
  {
    ...
    while($row = $result->fetch_assoc()){
      ...
      data-toggle='modal' data-target='#Edit_modal' id='".$row['position_id']."' name='".$row['position_name']."'>
      ...
      data-toggle='modal' data-target='#Delete_modal' id='".$row['position_id']."' name='".$row['position_name']."'>
