...
if(isset($_GET['t']))
{
    ...
    if ($result_row !== 0) // ถ้าใน Table มีข้อมูล
    {
        ...
        <div class="row">
            ...
            <p>
                ...
                ผลการค้นหา : ประเภท<?php echo $b['user_type_name'];?>
    ...
    <ul class="pagination pagination-md pull-right" style="margin:0px;">
        ...
        if($total_page > 1)
        {
            ...
            <li <?php if($page==1){echo 'disabled';}?>>
                ...
                if($page == 1){ $linkURL = "";}
                    ...
                    if(isset($_GET['t'])){$linkURL = "permission.php?page=".($page-1)."&t=".$_GET['t'];}
        ...
        if(isset($_GET['t']))
        {
            ...
            {
                ?>
                <li <?php if($page==$i){echo 'class=active';}?> ><a href="permission.php?page=<?php echo $i."&t=".$_GET['t']?>"><?php echo $i; ?></a></li>
                <?php
            }
        }
        else 
...
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
            ...
            <div class="panel-heading">
                <h3 class="panel-title">ดูข้อมูลตามประเภท</h3>
            </div>
